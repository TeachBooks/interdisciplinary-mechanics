...
$$\begin{align}
        &\frac{\partial u_x^+}{\partial t} && \hspace{-5em}= \frac{\partial u_x^+}{\partial \tau} \frac{\partial \tau}{\partial t} = \frac{\partial u_x^+}{\partial \tau} \cdot 1 \quad \rightarrow \quad \frac{\partial^2 u_x^+}{\partial t^2} = \frac{\partial^2 u_x^+}{\partial \tau^2} \hfill \\
        &\; \\
        &\frac{\partial u_x^+}{\partial x} && \hspace{-5em}= \frac{\partial u_x^+}{\partial \tau} \frac{\partial \tau}{\partial x} = \frac{\partial u_x^+}{\partial \tau} \cdot \left(-\frac{1}{c}\right) \quad \rightarrow \hfill \\
        ...
        &\quad \quad && \hspace{-5em}= \frac{\partial^2 u_x^+}{\partial \tau^2} \cdot \left(-\frac{1}{c}\right) \cdot \left(-\frac{1}{c}\right) = \frac{1}{c^2} \frac{\partial^2 u_x^+}{\partial \tau^2}  \hfill\\
\end{align}$$ (4.1)
