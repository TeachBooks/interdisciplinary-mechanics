...
For the case without resistance ($\Phi=0$), use the reduced telegraph equation (answer to previous question) to obtain $P_{1,2} (Hint: they are two opposite complex roots).
