...
````{admonition} Model answer
:class: dropdown
We know from that $\tilde{Q}(s)=\frac{\omega B}{\gamma}C_1e^{-i\gamma s}$ and from question 19 the value of $C_1$. In maple is computed as follows, noting that $e^{-i\gamma s}=1$.
